...
\caption{Spektrogram orchestrální skladby s obtížně detekovatelnou melodií. Pro refrenční přepis melodie viz obrázek \ref{obr:input_output}}
...
V této práci se pokusíme navázat na zmiňované práce a otestovat nové architektury hlubokých neuronových sítí pro úlohu extrakce melodie.
